...
const currentTemp: Ref<string> = ref(temps.value[1]);
const currentBase: Ref<BaseBeverageType> = ref(bases.value[1]);
const currentCreamer: Ref<CreamerType> = ref(creamers.value[1]);
const currentSyrup: Ref<SyrupType> = ref(syrups.value[1]);
